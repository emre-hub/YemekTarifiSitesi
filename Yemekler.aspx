<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="Yemekler.aspx.cs" Inherits="Yemek_Tarifi_Sitesi_ASPNET.Yemekler" %>
            ...
            <ItemTemplate>
                ...
                <table class="auto-style7">
                    ...
                    <tr>
                        ...
                        <td class="auto-style9">
                            <a href ="YemekDuzenle.aspx?YemekId=<%#Eval("YemekId")%>"><asp:Image ID="Image3" runat="server" Height="30px" ImageUrl="~/Images/update.png" Width="30px" /></a>
                        </td>
    ...
    <asp:Panel ID="Panel3" runat="server" CssClass="auto-style14" >
        <table class="auto-style5">
            <tr>
                ...
                <td style="color: white">Yemek Ekle</td>
            </tr>
        </table>
</asp:Panel>
        ...
        <table class="auto-style5">
            ...
            <tr>
                ...
                <td class="auto-style19"><strong>
                    <asp:Button ID="btnEkle" runat="server" CssClass="auto-style17" Height="40px" Text="Ekle" Width="200px" OnClick="btnEkle_Click" />
                    </strong></td>
            </tr>
        </table>
    </asp:Panel>
